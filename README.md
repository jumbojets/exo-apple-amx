...
* test_appleamx_ops.py: Checks every generated instruction against the hardware, and the matmul example against its naive version.
...
Scheduled:     2314.099 gflops (78% max)
Max:           2958.9   gflops
```
